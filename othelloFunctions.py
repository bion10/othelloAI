...
##        myPiece.move(dx, dy)
    ...
    def colorFlip(tiles, turn_color, opponent_color, piecepos):
           ...
           # ydireclist = [-1,0,1,-1,1,-1,0,1]
            ...
            for dx in [-1,0,1]:
                for dy in [-1,0,1]:
                    ...
                    if turn_color == "white":
                        while tiles[xmove,ymove] == opponentColor:
                            whitepiece = Piece("white", tiles[xmove,ymove],win)
                            whitePieceList.append(whitepiece)
                            xmove = xmove + dx
                            ymove = ymove + dy
                            if tiles[xmove,ymove] == turn_color or tiles[xmove,ymove] == "":
                                break


                    if turn_color == "black": 
                        while tiles[xmove,ymove] == opponentColor:
                            blackpiece = Piece("black", tiles[xmove,ymove],win)
